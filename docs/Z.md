...
$$
\begin{align*}
S_{11} &= \frac{(Z_{11}-Z^{*}_{01})(Z_{22}+Z_{02}) - Z_{12} Z_{21}}{(Z_{11}+Z_{01})(Z_{22}+Z_{02}) - Z_{12} Z_{21}} \\
%
...
%
S_{22} &= \frac{(Z_{11}+Z_{01})(Z_{22}-Z^{*}_{02}) - Z_{12} Z_{21}}{(Z_{11}+Z_{01})(Z_{22}+Z_{02}) - Z_{12} Z_{21}} \\
\end{align*}
$$
