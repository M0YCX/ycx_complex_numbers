...
$$
\begin{align*}
S_{11} &= \frac{(1-Y_{11} Z^{*}_{01})(1+Y_{22} Z_{02}) + Y_{12} Y_{21} Z^{*}_{01} Z_{02}}{(1+Y_{11} Z_{01}) (1+Y_{22}Z_{02}) - Y_{12} Y_{21} Z_{01} Z_{02}} \\
%
...
%
S_{22} &= \frac{(1+Y_{11} Z_{01})(1-Y_{22} Z^{*}_{02}) + Y_{12} Y_{21} Z_{01} Z^{*}_{02}}{(1+Y_{11} Z_{01}) (1+Y_{22}Z_{02}) - Y_{12} Y_{21} Z_{01} Z_{02}} \\
\end{align*}
$$
